  ...
  cout << "Data reading in progress...\n";
    ...
    string line;
      ...
      getline(linestream, tempLine, '\t');
               ...
               // void * pointer stores the address of the block, but in order to perform pointer arithmetic we have 
               // to cast into uint or uchar pointer.

               // memcpy may seem to be potentially dangerous, but it is safe in this usage as it is the only function 
               // that allows copying of byte data and it is being performed inside the container.
    ...
    cout << "Reading completed!\n";
          ...
          cout << "5. Number of Available Blocks Left: " << memory_pool.getBlocksAvailable() << "\n"
               << '\n';
